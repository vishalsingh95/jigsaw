...
$mail->SMTPSecure = "ssl";
$mail->Port = 465;
$mail->Username = "jigsaw.enquiry.web@gmail.com";
$mail->Password = "jigsawedusolutions";

$mail->From = "jigsaw.enquiry.web@gmail.com";
$mail->FromName = "jigsaw ad enquiry";
$mail->AddAddress("jigsaw.enquiry.web@gmail.com","vanshika.raheja@jigsaw.edu.in");
...
<tr style='background-color:#ddd;'><th>Contact Number</th><td>$franContact</td></tr><br>
<tr style='background-color:#ddd;'><th>Interested Location</th><td>$franLocation</td></tr><br>
