...
$mail->SMTPSecure = "ssl";
$mail->Port = 465;
$mail->Username = "jigsaw.query.web@gmail.com";
$mail->Password = "jigsawedusolutions";

$mail->From = "jigsaw.query.web@gmail.com";
$mail->FromName = "jigsaw ad enquiry";
$mail->AddAddress("jigsaw.query.web@gmail.com","vanshika.raheja@jigsaw.edu.in");
...
<h3 style='background-color: #fabcb6;'>Recruitment Form</h3><br><br>
<tr style='background-color:#ddd;'><th>Name of the child</th><td>$efname</td></tr><br>
<tr style='background-color:#ddd;'><th>Course</th><td>$ecourse</td></tr><br>
<tr style='background-color:#ddd;'><th>Email</th><td>$eemail</td></tr><br>
<tr style='background-color:#ddd;'><th>Contact</th><td>$enumber</td></tr><br>
<tr style='background-color:#ddd;'><th>Subject</th><td>$eage</td></tr><br>
</table>
</div>
