...
<div class="container">
<h2 class="dt-sc-hr-white-title">Recruitment Form</h2>
...
<input  name="recName" type="text" placeholder="Name" required="" style="margin-top:15px;">
</p>
<p class="dt-sc-one-third column">
<input  name="recEmail" type="text" placeholder="Email" required="" style="margin-top:15px;">
</p>
<p class="dt-sc-one-third column ">
<input  name="recContact" type="text" placeholder="Phone No." required="" style="margin-top:15px;">
</p>

<p>
<textarea id="admission" name="recAddress" placeholder="Enter Your Address" style="margin-top:15px;"></textarea>
</p>


<p class="dt-sc-one-half column first">
<input  name="recQualification" type="text" placeholder="Qualification" required="" style="margin-top:15px;">
</p>
<p>
<textarea id="admission" name="recExperience" placeholder="Work Experience" style="margin-top:15px;"></textarea>
</p>

<div id="ajax_admission_msg"> </div>
<p class="aligncenter">
<button class="dt-sc-button medium burnt-orange" name="fransubmit" type="submit" id="submit" value="Submit Form">Submit</button>
</p>
</form>

 <?php 
        if(isset($_POST['fransubmit']))
        {
        ...
        $recQualification=$_POST['recQualification'];
        $recExperience=$_POST['recExperience'];
        




        $ad_prdt="insert into recruitmentform set
        recName='$recName',
        recEmail='$recEmail',
        recContact='$recContact',
        recAddress='$recAddress',
        recQualification='$recQualification',
        recExperience='$recExperience'";

        $qst_ad_prdt=$db->query($ad_prdt);

        if($qst_ad_prdt)
        {
            // include('recruitment-form-mail.php');
