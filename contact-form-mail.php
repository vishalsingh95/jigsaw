...
$mail->SMTPSecure = "ssl";
$mail->Port = 465;
$mail->Username = "enquiry@jigsawabacus.com";
$mail->Password = "jigsaw@3208";

$mail->From = "enquiry@jigsawabacus.com";
$mail->FromName = "jigsaw ad enquiry";
$mail->AddAddress("enquiry@jigsawabacus.com","vanshika.raheja@jigsaw.edu.in");
...
<h3 style=' background-color: #fabcb6;'>Contact Form</h3><br><br>
<tr style='background-color:#ddd;'><th>Name</th><td>$txtname</td></tr><br>
<tr style='background-color:#ddd;'><th>Email</th><td>$txtemail</td></tr><br>
<tr style='background-color:#ddd;'><th>Subject</th><td>$txtsubject</td></tr><br>
<tr style='background-color:#ddd;'><th>Enquiry Type</th><td>$txtselect</td></tr><br>
<tr style='background-color:#ddd;'><th>Message</th><td>$txtmessage</td></tr><br>
</table>
</div>
